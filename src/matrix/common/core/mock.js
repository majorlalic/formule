import { InteractionType, ActionType, ElementType, SceneType, Colors, NameModes, ElementBehavior } from "./const.js";
export const scenes = [
    {
        id: "9832789237491283",
        name: "场景A",
                    ...
                    trigger: [
                        {
                            ...
                            actionType: ActionType.ChangeScene,
                            actionOptions: {
            ...
            },
            {
                ...
                conf: {
                    ...
                    trigger: [
                        ...
                        //
                        //     actionType: ActionType.ExecuteScript,
                        //     actionOptions: {
                    ...
                    trigger: [
                        {
                            ...
                            actionType: ActionType.ExecuteScript,
                            actionOptions: {
                                url: "/matrix/common/scripts/robot.js",
                            },
                        },
                    ],
                },
                    ...
                    trigger: [
                        {
                            ...
                            actionType: ActionType.ChangePosition,
                            actionOptions: {
                                position: {
